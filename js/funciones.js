...
$("#guardarInventario").click(function () {
    if ($.trim($("#idInventario").val()) == "" || $.trim($("#brandRegistro").val()) == "" || $.trim($("#categoryRegistro").val()) == "" || $.trim($("#descriptionRegistro").val()) == "" || $.trim($("#priceRegistro").val()) == "" || $.trim($("#availabilityRegistro").val()) == "" || $.trim($("#availabilityRegistro").val()) == "" || $.trim($("#quantityRegistro").val()) == "" || $.trim($("#photographyRegistro").val()) == "") {
        alert("Por favor ingrese todos los campos");
    } else {
        let datos = {
            reference: $("#idInventario").val(),
...
function buscarPorIDInventario(idItem) {
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#idInventario").val(response.reference);
